...
type LocationDataServiceClient interface {
	...
	FindEventIdsWithin(ctx context.Context, in *LocationQueryObject, opts ...grpc.CallOption) (*EventsLists, error)
}
...
func (c *locationDataServiceClient) FindEventIdsWithin(ctx context.Context, in *LocationQueryObject, opts ...grpc.CallOption) (*EventsLists, error) {
	out := new(EventsLists)
...
type LocationDataServiceServer interface {
	...
	FindEventIdsWithin(context.Context, *LocationQueryObject) (*EventsLists, error)
...
func (UnimplementedLocationDataServiceServer) FindEventIdsWithin(context.Context, *LocationQueryObject) (*EventsLists, error) {
